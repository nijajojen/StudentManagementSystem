...
public class RecruitmentDto implements Serializable{
	...
	private List<RecruitmentHistoryDto> recruitmentHistoryDtos;
	
	
	
	public List<RecruitmentHistoryDto> getRecruitmentHistoryDtos() {
		return recruitmentHistoryDtos;
	}
	public void setRecruitmentHistoryDtos(List<RecruitmentHistoryDto> recruitmentHistoryDtos) {
		this.recruitmentHistoryDtos = recruitmentHistoryDtos;
	}
